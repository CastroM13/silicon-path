...
<ul>
  <li>
    ...
    <br>Complete the challenge using the language you feel most comfortable with.
  </li>
  <li>
    <strong>Wind becomes Lightning</strong>
    <br>Complete the challenge using the triforce of development: JavaScript, Python, and Ruby.
  </li>
  <li>
    <strong>Strike the Ivory Tower</strong>
    <br>Complete the challenge using Rust and Go.
  </li>
  <li>
    <strong>Navigate the Untamed Seas</strong>
    <br>Complete the challenge using the 3 C's: C#, C++, and C.
  </li>
  <li>
    <strong>The Silicon Path</strong>
    <br>Complete the challenge using: JavaScript, Python, Ruby, Java, Rust, Go, C++, C#, and C.
  </li>
</ul>
